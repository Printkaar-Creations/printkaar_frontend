    ...
    <>
      <div className='Footer'>
        <div className="footer-box">
          ...
          <div className="footer-boxes items">
            <div className="footer-call-box">
              ...
              <p>
                <Link to="tel: +919876543210">
                  +91 9876543210 (Contact us (24x7))
                </Link>
              </p>
            </div>
            <Link className="footer-email" to="email: printkaar@gmail.com">
              Email: printkaar@gmail.com
            </Link>
            <p>Delhi, India</p>
          </div>
          <div className="footer-icons">
            <p><Link to="http://instagram.com/printkaarcreations"><FaInstagram /></Link></p>
            <p><Link to="https://www.facebook.com/printkaarcreations/"><FaFacebook /></Link></p>
            <p><Link to="/"><FaYoutube /></Link></p>
            <p><Link to="/"><FaXTwitter /></Link></p>
          </div>
        </div>
        <div className='Footer-bottom'>
          <div className="footer-bottom-box">
            <p>© 2025 &nbsp;</p>
            <p>Printkaar | All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </>
